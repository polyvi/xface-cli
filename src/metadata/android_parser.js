        ...
        if (code != 0) {
            ...
            if (output.indexOf('android-17') == -1) {
                ...
                if (custom_path) {
                    ...
                    framework_path = util.getDefaultPlatformLibProject(project_root, 'android');
                }
...
module.exports.prototype = {
    ...
    update_www:function() {
        ...
        if (custom_path) {
            ...
            jsPath = path.join(util.getDefaultPlatformLibProject(projectRoot, 'android'), 'assets', 'www', 'cordova.js');
        }
