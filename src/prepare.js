    ...
    .then(function() {
        ...
        return Q.all(options.platforms.map(function(platform) {
            ...
            return q.then(function(libDir) {
                ...
                xplugin.prepare(platformPath, platform, plugins_dir, path.join(platformPath, '.xstaging'));

                // Make sure that config changes for each existing plugin is in place
                var munger = new xplugin.config_changes.PlatformMunger(platform, platformPath, plugins_dir);
